...
function ListTeachers(SearchKey) {
	...
	var URL = "https://localhost:44324/api/TeacherData/ListTeachers/" + SearchKey;
...
function UpdateTeacher(id) {
	...
	//goal: send a request which looks like this:
	//with POST data of teahcername, EmployeeNumber, Salary
	var URL = "https://localhost:44324/api/TeacherData/UpdateTeacher/" + id;
...
function DeleteTeacher(id) {
	...
	//URL
	var URL = `https://localhost:44324/api/TeacherData/DeleteTeacher/${id}`;
...
function ShowTeacher(id) {
	//URL
	var URL = `https://localhost:44324/api/TeacherData/FindTeacher/${id}`;
	...
	rq.onreadystatechange = function () {
		...
		if (rq.readyState == 4) {
			if (rq.status == 200) {
				...
				document.getElementById('EmployeeNumber').innerText = `Employee Number: ${teacherData.EmployeeNumber}`
				document.getElementById('HireDate').innerText = `HireDate: ${formattedHireDate}`
				document.getElementById('Salary').innerText = `Salary: ${formattedSalary}`
